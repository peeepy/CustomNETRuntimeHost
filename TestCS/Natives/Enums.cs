...
public enum NativeInputs : uint
{
    ...
    public enum PedDamageCleanliness
    {
    ...
    public enum PresenceEvents : uint
    {
    ...
    public enum OverheadTexture : uint
    {
