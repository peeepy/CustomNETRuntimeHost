...
//        private static Dictionary<uint, GCHandle> _renderCallbacks = new Dictionary<uint, GCHandle>();
//        private static List<GCHandle> _windowProcCallbacks = new List<GCHandle>();
...
//            RenderCallbackDelegate nativeCallback = (IntPtr userData) =>
//            {
//                try
//                {
//                    callback();
...
//                catch (Exception ex)
//                {
//                    Console.WriteLine($"Exception in render callback: {ex}");
//                }
//            };
...
//            if (success)
//            {
//                _renderCallbacks[priority] = handle;
//            }
//            else
//            {
//                handle.Free();
...
//                catch (Exception ex)
//                {
//                    Console.WriteLine($"Exception in window procedure callback: {ex}");
//                }
//            };

//            GCHandle handle = GCHandle.Alloc(wrappedCallback);
//            _windowProcCallbacks.Add(handle);
...
//            // Clean up GCHandles
//            foreach (var handle in _renderCallbacks.Values)
//            {
...
//            foreach (var handle in _windowProcCallbacks)
//            {
//                if (handle.IsAllocated)
//                    handle.Free();
//            }
//            _windowProcCallbacks.Clear();

//            // After native destruction and cleanup, destroy the ImGui context
